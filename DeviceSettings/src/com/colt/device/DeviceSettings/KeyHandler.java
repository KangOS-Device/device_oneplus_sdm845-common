...
package com.colt.device.DeviceSettings;
...
import com.colt.device.DeviceSettings.Constants;
import com.colt.device.DeviceSettings.DeviceSettings;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.colt.device.DeviceSettings",
